...
public class Customer_Menu extends javax.swing.JFrame {
    ...
    public Customer_Menu(String user, String cname, String add, int zip) {
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void OrderButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrderButtonActionPerformed
        Order_Menu om = new Order_Menu(username, name, address, zipcode);
        om.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_OrderButtonActionPerformed

    private void MenuButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuButtonActionPerformed
        Menu m = new Menu(username, name, address, zipcode);
        m.setVisible(true);
        this.dispose();
