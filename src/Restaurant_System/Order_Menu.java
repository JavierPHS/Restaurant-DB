...
public class Order_Menu extends javax.swing.JFrame {
    ...
    public Order_Menu(String user, String cname, String add, int zip) {
        initComponents();
        this.setLocationRelativeTo(null);
        username = user;
        name = cname;
    ...
    private void initComponents() {
        ...
        getContentPane().add(cartButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 10, 129, 54));
        ...
        getContentPane().add(returnButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 10, 129, 54));
    ...
    private void Finish_OrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Finish_OrderActionPerformed
        try {
            ...
            if (ps.executeUpdate() > 0) { //insert successful
                Receipt re = new Receipt(cartItem, cartQuantity, cartPrice, counter);
                re.setVisible(true);
                order = true;
            }
        } catch (Exception e) {
    ...
    private void cartButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cartButtonActionPerformed
        Cart c = new Cart(cartItem, cartQuantity, cartPrice, counter);
        c.setVisible(true);
        
    }//GEN-LAST:event_cartButtonActionPerformed

    private void returnButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnButtonActionPerformed
        Customer_Menu cm = new Customer_Menu(username, name, address, zipcode);
        cm.setVisible(true);
        this.dispose();
    ...
    private void statusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_statusButtonActionPerformed
        ...
        if (!order) {
            ...
            if (!status) {
                ...
                String query = "UPDATE Food_Order SET orderStatus = Delivered WHERE orderID = ?";
                ps = mySQLConnector.setConnection().prepareStatement(query);
                ps.setInt(1, orderID);
                if (ps.executeUpdate() > 0) { //insert successful
